...
static inline unsigned cs42l52_read_reg_cache(struct snd_soc_codec *codec,
		u_int reg)
{
                ...
                u_int reg, u_int val)
{
        ...
        data[0] = reg & 0xff;
        data[1] = val & 0xff;
        cs42l52_write_reg_cache(codec, data[0], data[1]);
...
static const char *cs42l52_adcb_text[] = { "AIN1B to ADC", "AIN2B to ADC", "AIN3B to ADC", "AIN4B to ADC" };
...
static const struct snd_soc_dapm_route cs42l52_audio_map[] = {
	...
	{"PGA Mux Left", "AIN2A to PGA", "INPUT2A"},
        {"PGA Mux Right", "AIN2B to PGA", "INPUT2B"},
	{"PGA Mux Left", "AIN3A to PGA", "INPUT3A"},
...
static int cs42l52_probe(struct snd_soc_codec *codec)
{
	...
	/*init done*/
        ...
        ret = snd_soc_add_controls(codec, cs42l52_snd_controls,
        ...
        ret = snd_soc_dapm_new_controls(codec, cs42l52_dapm_widgets,
        ...
        ret = snd_soc_dapm_add_routes(codec, cs42l52_audio_map,
...
struct snd_soc_codec_driver soc_codec_dev_cs42l52 = {
	...
	.resume = cs42l52_resume,
        .read = cs42l52_read_reg_cache,
        .write = cs42l52_write_reg,
	.set_bias_level = cs42l52_set_bias_level,
	.reg_cache_size = ARRAY_SIZE(cs42l52_reg), 
			     ...
			     const struct i2c_device_id *id)
{
	...
	i2c_set_clientdata(i2c_client,cs42l52);
 	cs42l52->control_type = SND_SOC_I2C;
        ...
        cs42l52->hw_write = (hw_write_t)i2c_master_send;
